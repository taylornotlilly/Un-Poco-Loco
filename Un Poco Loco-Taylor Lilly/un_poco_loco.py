...
# Sounds
jump_snd = load_sound('assets/sounds/jumpy.ogg')
gem_snd = load_sound('assets/sounds/coin.ogg')
BEG = load_sound('assets/sounds/title.ogg')
WIN = load_sound('assets/sounds/win.ogg')
LOSE = load_sound('assets/sounds/lose.ogg')
CLEAR = load_sound('assets/sounds/clear.ogg')
OOF = load_sound('assets/sounds/ow.ogg')

# Images
idle = load_image('assets/images/characters/MC.png')
walk = [load_image('assets/images/characters/walking.png'),
        load_image('assets/images/characters/walking2.png')]
jump = load_image('assets/images/characters/jumpy.png')
...
tile_images = { "Grass": load_image('assets/images/tiles/grass.png'),
                "Dirt": load_image('assets/images/tiles/dirt.png'),
                "Dirty": load_image('assets/images/tiles/dirty.png'),
                "Platform": load_image('assets/images/tiles/tile.png'),
                "Plant": load_image('assets/images/tiles/plant.png'),
                "FlagTop": load_image('assets/images/tiles/flag.png'),
                "FlagPole": load_image('assets/images/tiles/pole.png') }
        
basic_enemy_images = [ load_image('assets/images/characters/shoe-1.png.png'),
                       load_image('assets/images/characters/shoe-2.png.png')]

platform_enemy_images = [ load_image('assets/images/characters/shoe2-1.png.png'),
                          load_image('assets/images/characters/shoe2-2.png.png')] 

item_images = { "Gem": load_image('assets/images/items/hat.png') }

title_img = load_image('assets/images/backgrounds/titlescreen.png').convert_alpha()
lose_img = load_image('assets/images/backgrounds/loser.png').convert_alpha()
win_img = load_image('assets/images/backgrounds/winner.png').convert_alpha()
clear_img = load_image('assets/images/backgrounds/cleared.png').convert_alpha()
...
class Game():
    ...
    def show_cleared_screen(self):
        ...
        text = font_xl.render("Level cleared!", 1, WHITE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 372
        screen.blit(text, rect)
    ...
    def show_win_screen(self):
        ...
        text = font_xl.render("You win!!", 1, WHITE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 4
        rect.centery = 112
        screen.blit(text, rect)
    ...
    def show_lose_screen(self):
        ...
        text = font_xl.render("You lose!!", 1, WHITE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 4
        rect.centery = 112
        screen.blit(text, rect)

        text = font_sm.render("Press space to restart.", 1, WHITE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 4
        rect.centery = 172
        screen.blit(text, rect)
